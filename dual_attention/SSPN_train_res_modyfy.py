...
from sspn_version2 import SSFPN
import argparse
...
parser.add_argument('--sched', default='poly', type=str, metavar='SCHEDULER',choices=['cosine', 'tanh', 'step', 'multistep', 'poly'],
...
if __name__ == "__main__":
  ...
  #  model = ResNet152_FPN_attention()
    model = SSFPN("resnet152",pretrained=True)
    #  print(model)
