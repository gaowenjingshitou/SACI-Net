...
class _DAHead(nn.Module):
    ...
    def forward(self, x):
        feat_p = self.conv_p1(x)#torch.Size([2, 512, 14, 14])
        feat_p = self.pam(feat_p)#torch.Size([2, 512, 14, 14])
        feat_p = self.conv_p2(feat_p)#torch.Size([2, 512, 14, 14])

        feat_c = self.conv_c1(x)#torch.Size([2, 512, 14, 14])
        feat_c = self.cam(feat_c)#torch.Size([2, 512, 14, 14])
        feat_c = self.conv_c2(feat_c)#torch.Size([2, 512, 14, 14])
